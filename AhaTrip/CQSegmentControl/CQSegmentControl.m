...
#define		DEFAULTFONTSIZE				12.0f		//默认字体
...
- (void)setcustomizing
{
    ...
    UIImage *normal1 = [UIImage imageNamed:@"seg_All_Bg.png"];
	UIImage *normal2 = [UIImage imageNamed:@"seg_Sight_Bg.png"];
    UIImage *normal3 = [UIImage imageNamed:@"seg_Shopping_Bg.png"];
    ...
    UIImage *press3 = [UIImage imageNamed:@"seg_seleted_Shopping_Bg.png"];
    ...
    self.selectedItemColor = [UIColor clearColor];
    self.unselectedItemColor = [UIColor clearColor];
...
- (void)dealloc {
	...
	[normalImageItems_ release];
	normalImageItems_ = nil;
	
	[highlightImageItems_ release];
	highlightImageItems_ = nil;
	
	[selectedItemColor_ release];
	selectedItemColor_ = nil;
	
	[unselectedItemColor_ release];
	unselectedItemColor_ = nil;
...
- (void)setSelectedItemColor:(UIColor *)aColor {
	if (aColor != selectedItemColor_) {
		[selectedItemColor_ release];
		selectedItemColor_ = [aColor retain];
...
- (void)setUnselectedItemColor:(UIColor *)aColor {
	if (aColor != unselectedItemColor_) {
		[unselectedItemColor_ release];
		unselectedItemColor_ = [aColor retain];
...
- (void)drawRect:(CGRect)rect {
    ...
    DLog(@"%f  %d %f %f",rect.size.width,self.numberOfSegments,itemSize.width,itemSize.height);
