...
CGFloat LDegreesToRadians(CGFloat degrees) {return degrees * M_PI / 180;};
CGFloat LRadiansToDegrees(CGFloat radians) {return radians * 180/M_PI;};
...
{
    return [self imageRotatedByDegrees:LRadiansToDegrees(radians)];
}
...
- (UIImage *)imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation(LDegreesToRadians(degrees));
    ...
    CGContextRotateCTM(bitmap, LDegreesToRadians(degrees));
